...
%Image save
%imwrite(distorted_image, 'Distorted_image_scinic_initial_algorithm.jpg')
...
figure;
imshow(undistorted_image);
title('Corrected Image of Checker board');

% save corrected image
%imwrite(undistorted_image, 'corrected_image_scinic_initial_algorithm_average_k1.jpeg')

%Calculating Structural Similarity Index
ssim_val = ssim(input_image,undistorted_image);
